        ...
        {isExpanded && (
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
              <span style={{ fontSize: '0.8rem', color: P.muted, fontWeight: 500, letterSpacing: '0.02em' }}>
                Data Attribution
              </span>
              <button
