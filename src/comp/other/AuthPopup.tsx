        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: "var(--text-muted)" }}>
              {t(
                "yourSessionExpiredPleaseReauthenticate",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div>
            ...
            <input
              ...
              onKeyDown={(e) => {
                if (e.key === "Enter") void sendAuthReq();
              }}
            />
          </div>
          ...
          >
            <Trans i18nKey="demoStrongStyleColorVartextmutedDemostrongStrongStyleColorVartextmutedDemostrong">
              Demo: <strong style={{ color: "var(--text-muted)" }}>demo</strong>{" "}
              / <strong style={{ color: "var(--text-muted)" }}>demo</strong>
            </Trans>
          </p>
        </div>
      </div>
