    ...
    <View style={[s.fill, { backgroundColor: C.bg }]}>
          ...
          <View style={[s.modePill, { backgroundColor: C.segBg }]}>
            {(["auto", "manual"] as ScannerMode[]).map((m) => (
              <Pressable
                ...
                style={({ pressed }) => [
                  s.modePillItem,
                  scannerMode === m && { backgroundColor: C.surface, shadowColor: "#000", shadowOpacity: 0.05, shadowRadius: 4, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
                  pressed && { opacity: 0.8 },
                ]}
          ...
          <View style={[s.cameraWrap]}>
            ...
            {scanned && (
              <View style={s.cancelScanWrap}>
                <Pressable
                  style={({ pressed }) => [s.abortBtn, pressed && { opacity: 0.7 }]}
                  disabled={sending}
                  onPress={() => {
            ...
            {!scanned && (
              <>
                ...
                {/* Corner marks */}
                {[
                  { top: "20%", left: "10%", borderTopWidth: 4, borderLeftWidth: 4 },
                  { top: "20%", right: "10%", borderTopWidth: 4, borderRightWidth: 4 },
                  { bottom: "40%", left: "10%", borderBottomWidth: 4, borderLeftWidth: 4 },
                  { bottom: "40%", right: "10%", borderBottomWidth: 4, borderRightWidth: 4 },
                ].map((style, i) => (
                  <View
                    key={i}
                    style={[
            ...
            <View style={[s.sheet, { backgroundColor: C.surface, borderColor: C.border }]}>
              ...
              <View style={s.eanRow}>
                <View style={s.eanTextCol}>
                  ...
                  <Text style={[s.eanValue, { color: C.text }]} numberOfLines={1} adjustsFontSizeToFit>
                    {ean}
                  </Text>
                </View>
              </View>
              ...
              <View style={s.actions}>
                ...
                >
                  <Text style={[s.btnPrimaryText, sending && { color: C.textSub }]}>
                ...
                >
                  <Text style={[s.btnDangerText, { color: C.dangerText }, sending && { color: C.textSub }]}>
      ...
      {scannerMode === "manual" && (
        ...
        >
          ...
          >
            <View style={[s.card, { backgroundColor: C.surface, shadowColor: "#000", shadowOpacity: 0.03, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 2 }]}>
              {/* Tab switcher */}
              <View style={[s.tabs, { backgroundColor: C.surfaceAlt }]}>
                {(["name", "barcode"] as ManualTab[]).map((tab) => (
                  <Pressable
                    ...
                    style={({ pressed }) => [
                      s.tabItem,
                      manualTab === tab && [s.tabItemActive, { backgroundColor: C.surface, shadowColor: "#000", shadowOpacity: 0.05, shadowRadius: 4, shadowOffset: { width: 0, height: 2 }, elevation: 2 }],
                      pressed && { opacity: 0.8 },
                    ]}
              ...
              {manualTab === "name" && (
                <View style={s.fieldGroup}>
                  <Text style={[s.fieldLabel, { color: C.text }]}>{t("itemName")}</Text>
                  <TextInput
                    style={[
                      s.textInput,
                      {
              ...
              {manualTab === "barcode" && (
                <View style={s.fieldGroup}>
                  <Text style={[s.fieldLabel, { color: C.text }]}>{t("barcodeLabel")}</Text>
                  <TextInput
                    style={[
                      s.textInput,
                      {
                        backgroundColor: C.surfaceAlt,
                        color: C.text,
                        borderColor: manualBarcode ? C.borderFocus : "transparent",
              ...
              {/* Count stepper */}
              <View style={s.stepperRow}>
                <Text style={[s.stepperLabel, { color: C.text }]}>{t("units")}</Text>
                <View style={[s.stepper, { backgroundColor: C.surfaceAlt }]}>
                  <Pressable
                    style={({ pressed }) => [
                      s.stepBtn,
                  ...
                  return (
                    <>
                      <Pressable
                        ...
                        onPress={onAdd}
                      >
                        <Text style={[s.btnPrimaryText, !isValid && { color: C.textSub }]}>
                          {sending ? t("working") : `${t("addBtn")} ${count}`}
                        </Text>
                      </Pressable>
                      <Pressable
                        style={({ pressed }) => [
                          s.btnDanger,
                          {
                            ...
                            borderColor: isValid ? C.dangerBorder : "transparent",
                          },
                          pressed && isValid && { opacity: 0.85, transform: [{ scale: 0.98 }] },
                          (!isValid || sending) && { opacity: 0.5 },
                        ]}
