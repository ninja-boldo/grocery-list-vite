          ...
          <View style={[styles.card, { backgroundColor: C.modalBg }]}>
            ...
            <View style={styles.headerWrap}>
              ...
              <View style={styles.headerTextWrap}>
                <Text style={[styles.title, { color: C.textBold }]}>Anmelden</Text>
                <Text style={[styles.subtitle, { color: C.textSub }]}>
                  Ihre Sitzung ist abgelaufen. Bitte authentifizieren Sie sich erneut.
                </Text>
              </View>
            </View>
            ...
            <View style={styles.formGroup}>
              <Text style={[styles.label, { color: C.labelText }]}>Benutzername</Text>
              <TextInput
                value={username}
            ...
            <View style={styles.formGroup}>
              <Text style={[styles.label, { color: C.labelText }]}>Password</Text>
              <TextInput
                value={password}
            ...
            <Text style={[styles.demoHint, { color: C.demoText }]}>
              Demo: <Text style={{ fontWeight: "700", color: isLight ? "#374151" : "#d1d5db" }}>demo</Text> /{" "}
              <Text style={{ fontWeight: "700", color: isLight ? "#374151" : "#d1d5db" }}>demo</Text>
            </Text>

            <Text style={[styles.serverText, { color: isLight ? "#9ca3af" : "#4b5563" }]}>
